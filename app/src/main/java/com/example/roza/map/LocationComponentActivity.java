...
public class LocationComponentActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1Ijoicm96emE4IiwiYSI6ImNqdjd5cG43ejAxbmw0MG1tenNleXN3M28ifQ.NkO1ikPnmlkecdndaaioqQ");
    ...
    public void onExplanationNeeded(List<String> permissionsToExplain) {
        Toast.makeText(this, "Approval is needed", Toast.LENGTH_LONG).show();
    }
